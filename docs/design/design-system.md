...
| 9 | **Private Gate** — the last page not visually designed. Home, Art Works (2C v2), Project Detail (1B v2), About Me (3B v2) and Contact (4B v2) each now have a candidate. | **Pending design exploration** |
